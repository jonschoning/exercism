...
toRNATests :: [Test]
toRNATests =
  [ testCase "transcribes cytidine unchanged" $ "C" @=? toRNA "C"
  , testCase "transcribes guanosine unchanged" $ "G" @=? toRNA "G"
  , testCase "transcribes adenosine unchanged" $ "A" @=? toRNA "A"
  , testCase "transcribes thymidine to uracil" $ "U" @=? toRNA "T"
