...
main :: IO ()
main = exitProperly $ runTestTT $ TestList [TestList allergiesTests]

allergiesTests :: [Test]
allergiesTests =
  [ testCase "no allergies at all" $ [] @=? allergies 0
  , testCase "allergic to just eggs" $ [Eggs] @=? allergies 1
  , testCase "allergic to just peanuts" $ [Peanuts] @=? allergies 2
  , testCase "allergic to just strawberries" $ [Strawberries] @=? allergies 8
  , testCase "allergic to eggs and peanuts" $ [Eggs, Peanuts] @=? allergies 3
  ...
  , testCase "is allergic to eggs" $ True @=? isAllergicTo Eggs 1
